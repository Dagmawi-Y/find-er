...
>
  ...
  <div class="w-full px-4 mb-7">
    ...
    <select class="select select-bordered w-full text-black font-bold mb-5">
      <option disabled selected>Where is your company based?</option>
    ...
    <select class="select select-bordered w-full text-black font-bold mb-5">
      <option disabled selected>Industry 1</option>
      <option>IT</option>
    ...
    <Tooltip
      class=" bg-primary-light text-black duration-500"
      trigger="click"
      placement="top-end">Enter the sector your business is categorized</Tooltip
    >
    <select class="select select-bordered w-full text-black font-bold mb-5">
      <option disabled selected>Industry 2 (Optional)</option>
      <option>IT</option>
      <option>Software</option>
      <option>Agriculture</option>
    </select>
    ...
    >
    <select class="select select-bordered w-full text-black font-bold mb-5">
      <option disabled selected>Ideal Investor Role</option>
      <option>None</option>
    ...
    <Tooltip
      class=" bg-primary-light text-black duration-500"
      trigger="click"
      placement="top-end">How involved do you want the investor to be?</Tooltip
    >
    <div class="flex items-center rounded-lg bg-slate-200 mb-5">
      ...
      />
      <select class="select select-bordered w-full text-black font-bold">
    ...
    <a href="/entrepreneur/addPitch/pitchDeal">
      <button class="btn glass bg-primary w-1/2 mt-3">Next</button></a
    >
  </div>
</div>
